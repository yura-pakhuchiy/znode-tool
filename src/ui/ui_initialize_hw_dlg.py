...
class Ui_HwInitializeDlg(object):
    def setupUi(self, HwInitializeDlg):
        ...
        self.verticalLayout_16 = QtWidgets.QVBoxLayout(self.pgStepHwFirmwareList)
        ...
        self.gbFirmwareSourceType = QtWidgets.QGroupBox(self.pgStepHwFirmwareList)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.wdgFirmwareFile.sizePolicy().hasHeightForWidth())
        ...
        self.btnChooseFirmwareFile = QtWidgets.QToolButton(self.wdgFirmwareFile)
        ...
        self.tabFirmwareWebSources = QtWidgets.QTableWidget(self.pgStepHwFirmwareList)
        ...
        self.verticalLayout_18 = QtWidgets.QVBoxLayout(self.pgStepHwFirmwareUpload)
        self.verticalLayout_18.setContentsMargins(6, 6, 6, 6)
        self.verticalLayout_18.setSpacing(6)
        self.verticalLayout_18.setObjectName("verticalLayout_18")
        self.lblUploadFirmwareMessage = QtWidgets.QLabel(self.pgStepHwFirmwareUpload)
...
""))
        ...
        self.rbActUploadFirmware.setText(_translate("HwInitializeDlg", "Upload firmware"))
        ...
        self.gbTrezorModel.setTitle(_translate("HwInitializeDlg", "Trezor model"))
        self.rbTrezorModelOne.setText(_translate("HwInitializeDlg", "Trezor One"))
        self.rbTrezorModelT.setText(_translate("HwInitializeDlg", "Trezor T"))
        self.gbFirmwareSourceType.setTitle(_translate("HwInitializeDlg", "Firmware source"))
        self.rbFirmwareSourceLocalFile.setText(_translate("HwInitializeDlg", "Local file"))
        self.rbFirmwareSourceInternet.setText(_translate("HwInitializeDlg", "Internet"))
        self.chbWipeDevice.setToolTip(_translate("HwInitializeDlg", "Check if you would like to wipe your device data (seed, pin) during the process.\n"
...
"For an official firmware, you can uncheck this option."))
        self.chbWipeDevice.setText(_translate("HwInitializeDlg", "Clear device data"))
        self.label_4.setText(_translate("HwInitializeDlg", "File:"))
        self.btnChooseFirmwareFile.setText(_translate("HwInitializeDlg", "..."))
        item = self.tabFirmwareWebSources.horizontalHeaderItem(0)
        item.setText(_translate("HwInitializeDlg", "Version"))
        item = self.tabFirmwareWebSources.horizontalHeaderItem(1)
        item.setText(_translate("HwInitializeDlg", "Model"))
        item = self.tabFirmwareWebSources.horizontalHeaderItem(2)
        item.setText(_translate("HwInitializeDlg", "Official"))
        item = self.tabFirmwareWebSources.horizontalHeaderItem(3)
        item.setText(_translate("HwInitializeDlg", "Testnet"))

...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.chbHwKeepKey.setVisible(False)
        ...
        self.chbConfirmWhenVoting.setVisible(False)
        ...
        self.chbAddRandomOffsetToVotingTime.setVisible(False)
        ...
        self.chbDownloadProposalExternalData.setVisible(False)

...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "Znode"))
        self.cboMasternodes.setToolTip(_translate("MainWindow", "List of configured Znodes"))
        self.btnNewMn.setToolTip(_translate("MainWindow", "Create a new Znode configuration"))
        self.btnNewMn.setText(_translate("MainWindow", "New"))
        self.btnDuplicateMn.setToolTip(_translate("MainWindow", "Duplicate Znode entry"))
        self.btnDuplicateMn.setText(_translate("MainWindow", "Duplicate"))
        self.btnDeleteMn.setToolTip(_translate("MainWindow", "Delete current Znode configuration"))
        ...
        self.edtMnIp.setToolTip(_translate("MainWindow", "The Znode\'s IP address for incoming communication with other nodes"))
        self.label_11.setText(_translate("MainWindow", "port:"))
        self.edtMnPort.setToolTip(_translate("MainWindow", "The Znode\'s TCP port number for incoming communication with other nodes"))
        self.chbUseDefaultProtocolVersion.setToolTip(_translate("MainWindow", "Use the protocol version number (from the RPC node) when starting Znode"))
        self.chbUseDefaultProtocolVersion.setText(_translate("MainWindow", "Use default protocol version"))
        self.edtMnProtocolVersion.setToolTip(_translate("MainWindow", "Enter the protocol version number to be sent at Znode start time"))
        ...
        self.edtMnCollateralTx.setToolTip(_translate("MainWindow", "The collateral transaction hash from the 1000 XZC deposit"))
        self.label_7.setText(_translate("MainWindow", "TX index:"))
        self.edtMnCollateralTxIndex.setToolTip(_translate("MainWindow", "The collateral transaction\'s (unspent) output index with the 1000 XZC deposit (usally 0)"))
        self.edtMnCollateralAddress.setToolTip(_translate("MainWindow", "Zcoin address of the 1000 XZC collateral, coverted from BIP32 path with hardware wallet."))
        self.edtMnCollateralAddress.setPlaceholderText(_translate("MainWindow", "Zcoin address"))
        self.btnHwAddressToBip32.setToolTip(_translate("MainWindow", "Convert Zcoin address to BIP32 path using hardware wallet"))
        self.btnHwBip32ToAddress.setToolTip(_translate("MainWindow", "Convert BIP32 path to Zcoin address using hardware wallet"))
        self.edtMnCollateralBip32Path.setToolTip(_translate("MainWindow", "BIP32 path of the 1000 XZC collateral (e.g. 44\'/5\'/0\'/0/0)"))
        ...
        self.label_9.setText(_translate("MainWindow", "Znode private key:"))
        self.label_8.setText(_translate("MainWindow", "Znode status:"))
        self.label_12.setText(_translate("MainWindow", "Name:"))
        self.edtMnName.setToolTip(_translate("MainWindow", "The Znode\'s configuration name"))
        ...
        self.label_5.setText(_translate("MainWindow", "Znodes:"))
        self.label_10.setText(_translate("MainWindow", "IP:"))
        self.edtMnPrivateKey.setToolTip(_translate("MainWindow", "Znode\'s private key. Use your own or click the button <Generate new> to create a new and random private key with the use of \'bitcoin\' library."))
        self.btnRefreshMnStatus.setToolTip(_translate("MainWindow", "Get Znode\'s status"))
        self.btnRefreshMnStatus.setText(_translate("MainWindow", "Get status"))
        self.btnBroadcastMn.setToolTip(_translate("MainWindow", "Broadcast information about the Znode"))
        self.btnBroadcastMn.setText(_translate("MainWindow", "Start Znode using hardware wallet"))
        ...
        self.action_transfer_funds_for_cur_mn.setText(_translate("MainWindow", "Transfer Funds for Current Znode..."))
        self.action_transfer_funds_for_all_mns.setText(_translate("MainWindow", "Transfer Funds for All Znodes"))
        self.action_transfer_funds_for_any_address.setText(_translate("MainWindow", "Transfer Funds for Any Address"))
        self.action_sign_message_for_cur_mn.setText(_translate("MainWindow", "Sign Message for Current Znode..."))
        ...
        self.action_check_network_connection.setToolTip(_translate("MainWindow", "Check Zcoin Network Connection"))
        ...
        self.action_about_app.setText(_translate("MainWindow", "About Znode Tool..."))
        self.action_import_masternode_conf.setText(_translate("MainWindow", "Import Znodes from the znode.conf file..."))
        ...
        self.action_gen_mn_priv_key_compressed.setText(_translate("MainWindow", "Generate Znode private key (compressed)"))
        self.action_gen_mn_priv_key_compressed.setShortcut(_translate("MainWindow", "Ctrl+Alt+C"))
        self.action_gen_mn_priv_key_uncompressed.setText(_translate("MainWindow", "Generate Znode private key (uncompressed)"))
        self.action_gen_mn_priv_key_uncompressed.setToolTip(_translate("MainWindow", "Generate Znode private key (uncompressed)"))
